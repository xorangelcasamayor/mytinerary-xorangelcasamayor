...
//                   <h2 className="text-4xl font-bold text-gray-700">{itinerary.description}</h2>
            ...
            {Array.isArray(itineraries) && itineraries.length > 0 ? (
              itineraries.map((itinerary) => (
                <div key={itinerary._id} className="relative overflow-hidden w-full sm:w-[min(100%,40rem)] h-auto border bg-slate-50 dark:bg-black dark:border dark:border-slate-700 rounded-lg shadow-xl p-8 flex flex-col justify-between">
                  ...
                  {itinerary.photo && (
                    <div className="w-full h-72 bg-cover bg-center rounded-t-lg" style={{ backgroundImage: `url(${itinerary.photo})` }}>
                    </div>
                  )}

                  <h2 className="text-4xl font-bold text-gray-700 mt-4">{itinerary.description}</h2>
                  <div className="flex items-center mb-6">
                    <img 
                      src={itinerary.userPhoto} 
                      alt={itinerary.userName} 
